...
# --- 1. 페이지 기본 설정 ---
st.set_page_config(
    page_title="Streamlit 테트리스",
    page_icon="🔮",
    layout="wide"
)

# --- 2. 페이지 타이틀 ---
st.title("Streamlit 테트리스스 🔮")
...
with col1:
    st.write("이미지 표시 예제")
    st.image("https://youtu.be/c_xvBZNKa9g?si=OpX3Mlt02H6l44at 로고")

with col2:
    st.write("유튜브 동영상 예제")
    st.video("https://www.youtube.com/watch?v=c_xvBZNKa9g")
